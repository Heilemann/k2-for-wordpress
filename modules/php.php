...
function php_sidebar_module_control() {
	...
	?>
		<p><label for="php-module-code">Module's code:</label><br /><textarea id="php-module-code" name="php_module_code" rows="6" cols="30"><?php echo(wp_specialchars(htmlspecialchars(sbm_get_option('code'), ENT_QUOTES), 1)); ?></textarea></p>
	<?php
}
