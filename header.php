...
<head profile="http://gmpg.org/xfn/11">
	...
	<?php /* Live Commenting */ if ((get_option('k2livecommenting') == 1) and ((is_page() or is_single()) and ('open' == $post-> comment_status) or ('comment' == $post-> comment_type) )) { ?>
...
<div id="page">
	...
	<div id="header">
		...
		<ul class="menu">
			<li class="<?php if ( is_home() or is_archive() or is_single() or is_paged() or is_search() or (function_exists('is_tag') and is_tag()) ) { ?>current_page_item<?php } else { ?>page_item<?php } ?>"><a href="<?php echo echo get_settings('home').'/'; ?>/"><?php echo get_option('k2blogornoblog'); ?></a></li>
