...
class K2Styles {
	 ...
	 */
	function install() {
		add_option('k2styles', 		array('k2.classic/k2.classic.css'), 'Choose the Style you want K2 to use');
		...
		add_option('k2stylesurl', 	TEMPLATEURL . '/styles', 'URL of K2 Styles - Autogenerated');
			...
			<table id="k2-styles" class="widefat" cellspacing="0">
				<thead>
					<tr>
						...
						<th class="manage-column column-description"><?php _e('Description', 'k2'); ?></th>
					</tr>
				</thead>
					...
					<?php else: foreach( $style_files as $style ): ?>
						<tr>
							...
							<td class="column-title">
								<span class="style-name"><a href="<?php echo $style['stylelink']; ?>"><?php echo $style['stylename']; ?></a> <?php echo $style['version']; ?> by <a href="<?php echo $style['site']; ?>"><?php echo $style['author']; ?></a></span>
...
<?php
	...
	function get_style_data( $style_file = '' ) {
		...
		if ( preg_match("|Author\s*:(.*)$|mi", $style_data, $author) )
			$author = trim( $author[1] );
		else
			$author = '';

		if ( preg_match("|Author URI\s*:(.*)$|mi", $style_data, $site) )
		...
		if ( preg_match("|Description\s*:(.*)$|mi", $style_data, $description) )
			$description = trim( $description[1] );
		else
			$description = '';

		if ( preg_match("|Footer\s*:(.*)$|mi", $style_data, $footer) )
