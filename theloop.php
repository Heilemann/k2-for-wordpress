						...
						<?php /* Date & Author */
							printf(	__('Published %1$s %2$s','k2_domain'),
								...
								'<abbr class="published" title="'. get_the_time('Y-m-d\TH:i:sO') . '">' .
 								( function_exists('time_since') ? sprintf(__('%s ago','k2_domain'), time_since(abs(strtotime($post->post_date_gmt . " GMT")), time())) : sprintf(__('at %s','k2_domain'), get_the_time($dateformat)) ) 
 								. '</abbr>'
 								); 
 						?>
					</span>
