...
/*
*
* Some PHP 5 goodness that allows me to 
* dynamically load methods as they are called.
*
*/
...
function menu() {
	...
	include(TEMPLATEPATH . '/app/display/form.php');
}

// include Hasse R. Hansen's K2 header plugin - http://www.ramlev.dk
require(TEMPLATEPATH . '/app/display/headers.php');
