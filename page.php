		...
		<div id="current-content">
			<div id="primarycontent" class="hfeed">
				...
				<div id="post-<?php the_ID(); ?>" class="<?php k2_post_class(); ?>">
					...
					<div class="page-head">
						<h2><a href="<?php the_permalink() ?>" rel="bookmark" title='<?php printf( __('Permanent Link to "%s"','k2_domain'), wp_specialchars(strip_tags(get_the_title()),1) ); ?>'><?php the_title(); ?></a></h2>
